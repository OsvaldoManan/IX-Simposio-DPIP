...
baremo_section = (
    ...
    f'<div class="vote-actions"><a class="button button-light" href="evaluar.html">{ICON_VOTE} Evaluar una mesa</a>'
    f'<a class="button button-outline" href="qr.html">{ICON_QR} Hoja de códigos QR</a></div>'
    f'<p class="vote-result-note">{ICON_CHECK} Los resultados se darán a conocer en la ceremonia de clausura y premiación.</p>'
    '</div>'
