...
baremo_section = (
    ...
    '<div class="vote-copy">'
    '<div class="section-status-line"><p class="eyebrow">07 · Evaluación de ponencias</p><span class="upcoming-badge">Acceso restringido · 3 evaluadores</span></div>'
    '<h2>Evalúa cada ponencia de la mesa.</h2>'
    '<p>Formulario reservado a las tres personas evaluadoras designadas, que ingresan con su cuenta. Presenta a las cuatro ponencias de la mesa, una por página, con tres preguntas en escala de 0 a 5, y cierra con la elección de la mejor ponencia del panel. Un código QR por mesa.</p>'
    ...
    f'<a class="button button-outline" href="qr.html">{ICON_QR} Hoja de códigos QR</a></div>'
    f'<p class="vote-result-note">{ICON_CHECK} Los resultados solo son visibles para las personas evaluadoras con sesión iniciada.</p>'
    '</div>'
